...
@WebServlet("/CreerEtapeColisServlet")
public class CreerEtapeColisServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        etapeColisOperation.addColisEtapeColis(operation.findColisById(id), emplacement, etat, latitude, longitude);
